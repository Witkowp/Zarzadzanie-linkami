...
--
-- Host: 127.0.0.1
-- Czas generowania: 15 Maj 2017, 21:47
...
INSERT INTO `linki` (`urlId`, `url`, `nazwa`) VALUES
(1, 'https://www.youtube.com/watch?v=99JAI24Zd24', 'Kurs MySql'),
(2, 'https://www.facebook.com/', 'facebook'),
(10, 'http://docs.oracle.com/javase/7/docs/technotes/guides/language/try-with-resources.html', 'try with statement'),
(12, '1', 'l');
...
--
ALTER TABLE `linki`
  MODIFY `urlId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
